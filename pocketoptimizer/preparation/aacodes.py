...
one_letter = {
    ...
    'ALC': 'A', 'ALG': 'R', 'ALM': 'A', 'ALN': 'A',
    'ALO': 'T', 'ALQ': 'X', 'ALS': 'A', 'ALT': 'A', 'ALY': 'K',
    'AP7': 'A', 'APE': 'X', 'APH': 'A', 'API': 'K', 'APK': 'K',
    'APM': 'X', 'APP': 'X', 'AR2': 'R', 'AR4': 'E',
    'ARM': 'R', 'AR0': 'R', 'ARO': 'R', 'ARV': 'X', 'AS ': 'A', 'AS2': 'D',
    ...
    'HHK': 'AK', 'HIA': 'H', 'HIC': 'H', 'HIQ': 'H',
    'HL2': 'L', 'HLU': 'L', 'HMF': 'A', 'HMR': 'R',
    'HOL': 'N', 'HPC': 'F', 'HPE': 'F', 'HPQ': 'F', 'HQA': 'A',
    'HRG': 'R', 'HRP': 'W', 'HS8': 'H', 'HS9': 'H',
...
special2standard = {key: one2three[value] for key, value in one_letter.items() if value in one2three.keys()}
